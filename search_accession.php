...
<body onload="document.reg.user_query.focus();">
  <div class="container-fluid" id="bg_1">
    ...
    <div class="container"  id="bg_1">
      ...
      <div class="navbar-collapse" id="mainNavBar">
        <ul class="nav navbar-nav navbar-left" style="margin-left:4%;">
          <li class="active"><a id="left" href="search_accession.php?q=">Search by Accession number</a></li>
          <li><a id="left" href="search_isbn.php?q=">Search by ISBN number</a></li>
          <li><a id="left" href="search_name.php?q=">Search by Name</a></li>
        </ul>
      </div>
</nav>
        <div class="modal-content" style="width:88.5%;margin-top:-1.7%;margin-left:5.8%;" id="bg_form">
          <div class="modal-body">
            <form name="reg" class="form-horizontal" style="margin-left:12%;" action="accession_results.php?q=" method="post">
    ...
    <div class="form-group">
       <label class="control-label col-sm-2" for="email">Bookself no :</label>
         <div class="col-sm-10">
             <p class="form-control-static"></p>
        </div>
      </div>
      <div class="form-group">
         <label class="control-label col-sm-2" for="email">row no :</label>
         <div class="col-sm-10">
          <p class="form-control-static"></p>
        </div>
        </div>
      <div class="form-group">
       <label class="control-label col-sm-2" for="email">column no :</label>
       <div class="col-sm-10">
        <p class="form-control-static"></p>
      </div>
      </div>
