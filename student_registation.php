    ...
    <div class="container"  id="bg_1">
      ...
      <div class="navbar-collapse" id="mainNavBar">
        <ul class="nav navbar-nav navbar-left" style="margin-left:4%;">
          <li class="active"><a id="left" href="student_registation.php?q=">Add new student / member</a></li>
          <li><a id="left" href="student_details.php?q=">Student details</a></li>
          <li><a id="left" href="student_update.php?q=">Edit student / member</a></li>
        </ul>
      </div>
</nav>
