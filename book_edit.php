    ...
    <div class="container"  id="bg_1">
      ...
      <div class="navbar-collapse" id="mainNavBar">
        <ul class="nav navbar-nav navbar-left" style="margin-left:4%;">
          ...
          <li class="active"><a id="left" href="book_edit.php?q= ">Edit book information</a></li>
        </ul>
      </div>
</nav>
        <div class="modal-content" style="width:88.5%;margin-top:-1.7%;margin-left:5.8%;" id="bg_form">
          <div class="modal-body">
            <form name="reg" class="form-horizontal" style="margin-left:12%;" method="POST" action="edit_results.php?q=" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="isbn_no" class="form-control" id="pwd" value="" style="width:40%;">
             </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="pwd">Book Title :</label>
            <div class="col-sm-10">
             <input type="text" name="book_title" class="form-control" id="pwd" value="" style="width:40%;">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="pwd">Auther Name :</label>
            <div class="col-sm-10">
             <input type="text" name="auther_name" class="form-control" id="pwd" value="" style="width:40%;">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="pwd">Choose Book :</label>
            <div class="col-sm-10">
             <input type="file" name="pdf" class="form-control" id="pwd" value="" style="width:40%;">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="pwd">Edition :</label>
            <div class="col-sm-10">
             <input type="text" name="edition" class="form-control" id="pwd" value="" style="width:40%;">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="pwd">Boolself no :</label>
            <div class="col-sm-10">
             <input type="text" name="bookself" class="form-control" id="pwd" value="" style="width:40%;">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="pwd">Row no :</label>
            <div class="col-sm-10">
             <input type="text" name="row_no" class="form-control" id="pwd" value="" style="width:40%;">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="pwd">Column no :</label>
            <div class="col-sm-10">
             <input type="text" name="column_no" class="form-control" id="pwd" value="" style="width:40%;">
            </div>
          </div>
         <div class="form-group">
